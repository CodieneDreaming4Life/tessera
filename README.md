...
> __Important: Release 0.8 Feature__ <br/>Tessera now supports pre-signed 'raw' transactions. Please refer the wiki section for API details and quorum js repo for usage. 
